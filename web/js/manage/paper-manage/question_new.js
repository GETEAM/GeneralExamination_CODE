$(function(){
	...
	$('.question-type-choose .question-type').click(function(){//根据选择的类型决定如何显示
		...
		$('#item-content-area .title').show();

		//获取从类型中得到的部分属性
		item = JSON.parse($(this).find('span').text());
		...
		"questions":[
		{"type":"SingleChoice","stem":"此处为单选小题题干，题干内容可以包括图片、音频以及视频等多媒体。",
		"options":["单选小题选项内容","单选小题选项内容","单选小题选项内容","单选小题选项内容"]},
		{"type":"SingleChoice","stem":"此处为单选小题题干，题干内容可以包括图片、音频以及视频等多媒体。",
		"options":["单选小题选项内容","单选小题选项内容","单选小题选项内容","单选小题选项内容"]},
		{"type":"SingleChoice","stem":"此处为单选小题题干，题干内容可以包括图片、音频以及视频等多媒体。",
		"options":["单选小题选项内容","单选小题选项内容","单选小题选项内容","单选小题选项内容"]},
		{"type":"SingleChoice","stem":"此处为单选小题题干，题干内容可以包括图片、音频以及视频等多媒体。",
		"options":["单选小题选项内容","单选小题选项内容","单选小题选项内容","单选小题选项内容"]}]};*/
		//handleQuestionTypeChange($questionTypeStructure);
			      ...
			      React.createElement("div", {className: "item-stem"}, 
			        React.createElement("div", {className: "item-stem-area"}, 
			          React.createElement("div", {className: "item-stem-content"}, 
			          	React.createElement("textarea",{rows:"8",cols:"100",className: "item-stem-input",placeholder:stem,onChange:self.handleStemLength}),
			            ...
			            options.map(function(option, i, options) {
			              return (
			                React.createElement("li", {className:  showOptionsOrderNum ? 'show-order-num' : 'no-order-num'}, 
			                  React.createElement("input", {type:'text',placeholder:option,'name':i,onChange:self.handleItemOptionContent}),
		  ...
		  render: function() {
		    ...
		    var question_stem = question.stem ? 
		      React.createElement("div", {className: "question-stem"},
		        React.createElement("input", {type:'text',placeholder:question.stem,onChange:self.handleQuestionStemTextContent}),
		    ...
		    if(type == "SingleChoice") {
		      	question_show = React.createElement(SingleChoice, {itemOptions: item_options, options: options, strict:strict,
		      	...
		      	question_show = React.createElement(MultipleChoice, {options: options, questionOrder: order, strict: strict,handleReferenceAnswer:this.handleReferenceAnswer,
		      		handleStrictMatch:this.handleStrictMatch,changeItemState: self.props.changeItemState});

		    }else if(type == "SimpleAnswer") {
		      	question_show = React.createElement(SimpleAnswer, {strict: strict,handleReferenceAnswer:this.handleReferenceAnswer,
		      		handleStrictMatch:this.handleStrictMatch,changeItemState: self.props.changeItemState});
		    ...
		    //答案解析区域
		    var answer_analysis = React.createElement("textarea",{rows:"3",cols:"100",className: "answer-analysis",placeholder:'答案解析',onChange:this.handleAnswerAnalysis});
				        ...
				        options.map(function(option, i, a) {
				          return (
				            ...
				            React.createElement("li", {className: ""}, 
				              	React.createElement("input", {type:'text',placeholder:option,name:i,onChange:self.handleQuestionOptionChange}),
				             	a.length > 2
								? 
		...
		var BlankFilling = React.createClass({displayName: "BlankFilling",
		  ...
		  render: function() {
		    ...
		    var strict = this.props.strict;//false
		  	...
		  	var answer_area = React.createElement("div",{className:'question-answer'},
		    	"正确答案： ",
		    	React.createElement("input",{type:'text',placeholder:'正确答案',onChange:this.handleReferenceAnswer}),
		    	React.createElement("label", {title: "考生答案和标准参考答案是否完全一致",className:'strict-match'}, 
		...
		var SimpleAnswer = React.createClass({displayName: "SimpleAnswer",
		  ...
		  render: function() {
		    ...
		    var strict = this.props.strict;//false
		  	...
		  	var answer_area = React.createElement("div",{className:'question-answer'},
		    	React.createElement("textarea",{rows:"5",cols:"85",placeholder:'正确答案',onChange:this.handleReferenceAnswer}),
		    	React.createElement("label", {title: "考生答案和标准参考答案是否完全一致",className:'strict-match'}, 
                    React.createElement("input", {type: "checkbox", name: "strict-match",defaultChecked:strict, onChange: this.handleStrictMatch}), 
                       	"是否严格匹配"
                )
