...
use ExaminationManageBundle\Entity\Examination;
use ExaminationManageBundle\Form\ExaminationType;
...
class ExaminationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ExaminationManageBundle:Examination')->findAll();
     ...
     * @Method("POST")
     * @Template("ExaminationManageBundle:Examination:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ExaminationManageBundle:Examination')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ExaminationManageBundle:Examination:edit.html.twig")
     */
