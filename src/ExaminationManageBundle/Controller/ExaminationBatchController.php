...
namespace ExaminationManageBundle\Controller;
...
use ExaminationManageBundle\Entity\ExaminationBatch;
use ExaminationManageBundle\Form\ExaminationBatchType;
...
class ExaminationBatchController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ExaminationManageBundle:ExaminationBatch')->findAll();
     ...
     * @Method("POST")
     * @Template("ExaminationManageBundle:ExaminationBatch:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ExaminationManageBundle:ExaminationBatch')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ExaminationManageBundle:ExaminationBatch:edit.html.twig")
     */
